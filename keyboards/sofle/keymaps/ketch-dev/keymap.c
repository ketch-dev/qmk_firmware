...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,   KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,     XXXXXXX,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI, KC_LCTRL, KC_LGUI,   KC_SPC, KC_LOWER,      KC_RAISE,  KC_LSFT, KC_BSPC, KC_LALT, KC_RGUI
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
