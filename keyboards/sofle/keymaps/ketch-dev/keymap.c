...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT ,KC_Z ,KC_X    ,KC_C    ,KC_V    ,KC_B           ,HYPR(KC_K),   /**/   HYPR(KC_H) ,KC_N   ,KC_M    ,KC_COMM ,KC_DOT ,KC_SLSH ,KC_RSFT ,
                       KC_LALT ,KC_LSFT ,KC_LGUI ,LCTL_T(KC_F14) ,KC_SYM    ,   /**/   KC_EXTEND  ,KC_SPC ,KC_LSFT ,KC_LALT ,KC_RGUI
    ),
    [_DHM] = LAYOUT(
        KC_ESC  ,KC_1 ,KC_2    ,KC_3    ,KC_4    ,KC_5           ,              /**/               KC_6   ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,KC_GRV  ,
        ...
        KC_LSFT ,KC_Z ,KC_X    ,KC_C    ,KC_D    ,KC_V           ,HYPR(KC_K),   /**/   HYPR(KC_H) ,KC_K   ,KC_H    ,KC_COMM ,KC_DOT  ,KC_SLSH ,KC_RSFT ,
                       KC_LALT ,KC_LSFT ,KC_LGUI ,LCTL_T(KC_F14) ,KC_SYM    ,   /**/   KC_EXTEND  ,KC_SPC ,KC_LSFT ,KC_LALT ,KC_LGUI
    ),
    [_MAP_GMS] = LAYOUT(
        KC_ESC    ,KC_1      ,KC_2      ,KC_3      ,KC_4      ,KC_5      ,              /**/               KC_6    ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,KC_GRV  ,
